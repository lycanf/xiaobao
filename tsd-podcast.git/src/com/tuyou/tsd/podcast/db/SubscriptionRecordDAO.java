...
public class SubscriptionRecordDAO extends BaseDAO {

	private static SubscriptionRecordDAO instance = null;

	private SubscriptionRecordDAO(Context mContext) {
		super(mContext, DBOpenHelper.FAVOURITE_RECORD_TABLE_NAME);
	}

	public static SubscriptionRecordDAO getInstance(Context context) {
		if (instance == null)
			instance = new SubscriptionRecordDAO(context);
		return instance;
	}
	 ...
	 */
	public long save(SubscriptionRecordEntity entity) {
		long rowId = -1;
	 ...
	 * @return
	 */
	public List<SubscriptionRecordEntity> readAll() {
		...
		List<SubscriptionRecordEntity> apps = null;
		...
		if (cursor != null) {
			if (cursor.moveToFirst()) {
				apps = new ArrayList<SubscriptionRecordEntity>();

				SubscriptionRecordEntity app = null;
				do {
					app = new SubscriptionRecordEntity();
					...
					if (encryptData != null) {
						...
						SubscriptionRecord detail = gson.fromJson(gsonString,
