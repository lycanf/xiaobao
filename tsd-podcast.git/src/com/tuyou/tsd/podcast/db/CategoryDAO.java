...
public class CategoryDAO extends BaseDAO {
	...
	private CategoryDAO(Context mContext) {
		super(mContext, DBOpenHelper.CATEGORY_TABLE_NAME);
	}
	...
	public List<CategoryEntity> readAll() {
		...
		if (cursor != null) {
			if (cursor.moveToFirst()) {
				apps = new ArrayList<CategoryEntity>();

				CategoryEntity app = null;
				do {
					app = new CategoryEntity();
