...
public class SubscriptionCategoryDAO extends BaseDAO {

	private static SubscriptionCategoryDAO instance = null;

	private SubscriptionCategoryDAO(Context mContext) {
		super(mContext, DBOpenHelper.SUBSCRIPTION_CATEGORY);
	}

	public static SubscriptionCategoryDAO getInstance(Context context) {
		if (instance == null)
			instance = new SubscriptionCategoryDAO(context);
		return instance;
	}
	 ...
	 */
	public long save(SubscriptionCategoryEntity entity) {
		long rowId = -1;
	 ...
	 * @return
	 */
	public List<SubscriptionCategoryEntity> readAll() {
		...
		List<SubscriptionCategoryEntity> apps = null;
		...
		if (cursor != null) {
			if (cursor.moveToFirst()) {
				apps = new ArrayList<SubscriptionCategoryEntity>();

				SubscriptionCategoryEntity app = null;
				do {
					app = new SubscriptionCategoryEntity();
					...
					if (encryptData != null) {
						...
						AudioCategory detail = gson.fromJson(gsonString,
								AudioCategory.class);
						if (detail != null) {
