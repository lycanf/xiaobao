...
public abstract class NanoHTTPD {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    if (!(e instanceof SocketException && "NanoHttpd Shutdown".equals(e.getMessage()))) {
                                        e.printStackTrace();
                                        LogUtil.v(LOG_TAG, "Shutdown" + e.getStackTrace().toString());
                                    }
                                } finally {
    ...
    protected class HTTPSession implements IHTTPSession {
        ...
        public HTTPSession(TempFileManager tempFileManager,
            ...
            headers.put("remote-addr", remoteIp);
            headers.put("http-client-ip", remoteIp);
            headers.put("local-addr", localAddress.getHostAddress().toString());
        }
        ...
        public void getBody() {
            try {
                ...
                while (rlen >= 0 && size > 0) {
                    ...
                    size -= rlen;
                    if (rlen > 0) {
                    	stringBuffer.append(new String(buf, 0, rlen));
                    }
                }
            	...
            	e.printStackTrace();
            	LogUtil.v(LOG_TAG, "get the content failed " + e.getMessage());
            }
        }
        ...
        private void decodeHeader(BufferedReader in, Map<String, String> pre, Map<String, String> parms, Map<String, String> headers)
            ...
            try {
                ...
                decodeUriPath(uri, pathSegments);
        ...
        private void decodeUriPath(String uri, List<String> p) {
        	if (uri == null) {
        		return;
        	}
