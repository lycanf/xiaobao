...
public class TasksCompletedView extends View {
	...
	private void initAttrs(Context context, AttributeSet attrs) {
		...
		mStrokeWidth = typeArray.getDimension(
				R.styleable.TasksCompletedView_strokeWidth, 20);
		mCircleColor = typeArray.getColor(
				R.styleable.TasksCompletedView_circleColor, 0x00000000);
		mRingColor = typeArray.getColor(
				R.styleable.TasksCompletedView_ringColor, 0xFF009deb);
		mBGRingColor = typeArray.getColor(
				R.styleable.TasksCompletedView_ringColor, 0x30FFFFFF);
	...
	private void initVariable() {
		...
		mBGRingPaint.setStrokeWidth(mStrokeWidth);
